const Steps = (props: { steps: string }) => {
  return (
    <ol className="my-10 custom-style space-y-10 p-5 rounded-lg">
      <li className="custom- my-5 text-[#1F1F1F] text-xs">{props.steps}</li>
      <li className=" my-5 text-[#1F1F1F] text-xs">
